    ...
    return Consumer(builder: (context, ref, c) {
      return Container(
        ...
        child: Column(children: [
          ...
          //     //     ),
          //     //     10);
          //     // ? this code for showing rating of shops works
          //     // ref.read(orderHistoryServiceProvider).getReviews(
          //     //     staffId: widget.requestedShopData.staff.id, clear: true);
          ...
          //     //     builder: (context) {
          //     //       return ShopProfile(
          //     //         staff: widget.requestedShopData.staff,
          //     //         shop: widget.requestedShopData.shop,
          //     //       );
          //     //     });
          //     // ?
          ...
          //               children: [
          //                 Text(
          //                   " ${widget.requestedShopData.staff.name}",
          ...
          //               crossAxisAlignment: CrossAxisAlignment.start,
          //               children: [
          //                 // ? This code for rating works
          //                 // CustomRating(
          //                 //   margin: EdgeInsets.symmetric(horizontal: 5.sw()),
          //                 //   short: true,
          //                 //   rating: widget.requestedShopData.staff.avgRating!,
          //                 //   itemSize: 15.sr(),
          //                 //   count: widget.requestedShopData.staff.rateCount!,
          //                 //   ignoreGestures: true,
          ...
          //                     ),
          //                   ),
          //                 //? This code for giving rating to shop works
          //                 // if (getStatusForFeedback(
          //                 //             widget.requestedShopData.status)
          //                 //         .index ==
      ...
      child: Container(
        child: Row(
          children: [
            ...
            Text(
              widget.requestedShopData.staff.phone,
              style: Theme.of(context).textTheme.bodyText2,
            ),
          ],
        ),
