...
class OrderDetail extends ConsumerWidget {
    ...
    return WillPopScope(
      ...
      child: SafeArea(
        ...
        appBar: ResponsiveLayout.isMobile
            ? simpleAppBar(context, title: "Order Details", search: false)
            : null,
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (selectedOrder.status < Status.packing.index ||
  ...
  Widget checkChanges(BuildContext context, Order order) {
    if (order.status != Status.packing.index &&
  ...
  Container grandTotal(BuildContext context, Order selectedOrder) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          if (selectedOrder.requestedShops.isNotEmpty &&
            ...
            InfoSpacedBox(
              showLabel: false,
              value:
                  "${selectedOrder.requestedShops.first.feedback.deliveryTime} min",
              label: "Delivery Time",
              verticalPadding: verticalPadding,
            ),
            InfoSpacedBox(
            ...
            InfoSpacedBox(
              value: selectedOrder.requestedShops.first.feedback.deliveryCharge
                  .toString(),
              label: "Delivery Fee",
              verticalPadding: verticalPadding,
            ),
